...
// IMPORTS
import { rand, sanitizar, verificarRateLimit, contarSilabas, ajustarSilabas, idsVistos, lexicoActivo } from './utils.js';
import { 
  ESTADO, 
  cambiarVida, 
  revivirOráculo, 
...
// 6. FUNCIÓN: GUARDAR PALABRA EN LÉXICO (Rayar)
...
export function configurarBotones() {
  ...
  if (btnPoesia) {
    btnPoesia.addEventListener('click', accionHaiku);
  }
